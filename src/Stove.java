...
public class Stove {
	...
	public void displayStove() {
		...
		for (Burner b : burners) {
			...
			System.out.println(b.mySetting.getSetting() + "....." + b.myTemperature.getTemp());
			// Checking if any burners are at the highest temperature setting to know when to display warning
			if(b.myTemperature.getTemp() == "VERY HOT! DON'T TOUCH") {
				danger = true;
			}
		}
		if (danger) {
